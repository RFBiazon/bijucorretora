            ...
            <CardHeader>
              ...
              <CardDescription>Informações do corretor responsável</CardDescription>
                      ...
                      <CardContent className="space-y-3 pb-4">
                        <div>
                          <Label>Nome</Label>
                          <Input value={editedProposta.corretor?.nome || ""} onChange={(e) => handleInputChange("corretor", "nome", e.target.value)} disabled={!isEditing} />
              </div>
                        <div>
                          <Label>SUSEP</Label>
                          <Input value={editedProposta.corretor?.susep || ""} onChange={(e) => handleInputChange("corretor", "susep", e.target.value)} disabled={!isEditing} />
              </div>
                        <div>
                          <Label>Email</Label>
                          <Input value={editedProposta.corretor?.email || ""} onChange={(e) => handleInputChange("corretor", "email", e.target.value)} disabled={!isEditing} />
              </div>
                        <div>
                          <Label>Telefone</Label>
                          <Input value={editedProposta.corretor?.telefone || ""} onChange={(e) => handleInputChange("corretor", "telefone", e.target.value)} disabled={!isEditing} />
              </div>
            </CardContent>
          </Card>
                  </MotionDiv>
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        <div>
                          ...
                          <p>Número: {editedProposta.proposta.numero || "N/A"}</p>
                          <p>Seguradora: {editedProposta.proposta.cia_seguradora || "N/A"}</p>
                        </div>
                        <div>
                          <h3 className="font-semibold mb-2">Segurado</h3>
                          <p>Nome: {editedProposta.segurado.nome || "N/A"}</p>
                          <p>CPF: {editedProposta.segurado.cpf || "N/A"}</p>
                        </div>
                        <div>
                          <h3 className="font-semibold mb-2">Veículo</h3>
                          <p>Marca/Modelo: {editedProposta.veiculo.marca_modelo || "N/A"}</p>
                          <p>Placa: {editedProposta.veiculo.placa || "N/A"}</p>
                        </div>
                      </div>
              </CardContent>
            </Card>
